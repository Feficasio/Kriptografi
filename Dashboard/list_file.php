<?php 
 ...
 if( !isset($_SESSION['username']) ){
     ...
     include '../config.php';
     $get_data=mysqli_query($conn,"SELECT * FROM file order by kd_user asc");
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" href="list_file.php">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                <h5 class="h5">List File</h5>
                <div class="row">
                    <div class="col-16">
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="list_user" class="table table-bordered">
                                        <thead>
                                          <tr>
                                        ...
                                        <tbody>
                                        <?php
                                        include'../function_user/list_file.php';
                                        ?>
                                        </tbody>
                                      </table>
                                </div>
