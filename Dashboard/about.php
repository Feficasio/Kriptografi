                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <center>
                                    <h4><p class="text-center">Aplikasi ini dibuat oleh:</p></h4>
                                    <img src = "../img/1811503174.jpg"  height="auto" width="130px">
                                    <h5><p class="text-xl-start">Nama : Fefi Casio</p></h5>
                                    <h5><p class="text-xl-start">Nim : 1811503174</p></h5>
                                    <h5><p class="text-xl-start">Fakultas : Teknologi Infornasi</p></h5>
                                    <h5><p class="text-xl-start">Dosen Pembimbing : Dewi Kusumaningsih, S.Kom., M.Kom </p></h5>
                                    </center>
                                </div>
                            </div>
                        </div>
